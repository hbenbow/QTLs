...
test$sum<-test$ERP003465+test$ERP013983+test$SRP060670
# ========================================================================================================================================
...
write.csv(mismatches, file="~/Documents/InnoVar/QTLs/QTL_data/Fg/mismatches.csv")
...
write.csv(all_markers_positions_filtered, file="~/Documents/InnoVar/QTLs/QTL_data/Fg/all_markers_positions_filtered.csv")
